...
def rank_and_basis(A: List[List[float]]) -> Tuple[int, List[List[float]], List[List[float]], List[List[float]]]:
    matrix_A = A
    """
    ...
    augmented_matrix, _, _ = gaussian_eliminate(matrix_A, [0.0] * rows_count, verbose=False)
