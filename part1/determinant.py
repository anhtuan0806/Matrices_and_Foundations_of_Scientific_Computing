...
def calculate_matrix_determinant(matrix_A: List[List[float]]) -> float:
    """
    ...
    try:
        ...
        augmented_matrix, _, swap_count = perform_gaussian_elimination(matrix_A, dummy_vector_b, verbose=False)
